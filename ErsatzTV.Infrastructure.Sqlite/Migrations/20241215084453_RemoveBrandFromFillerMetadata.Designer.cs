...
namespace ErsatzTV.Infrastructure.Sqlite.Migrations
{
    ...
    [Migration("20241215084453_RemoveBrandFromFillerMetadata")]
    partial class RemoveBrandFromFillerMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.Filler.Metadata.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.Filler.Metadata.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.FillerMetadata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("FillerMetadata", (string)null);
                });
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.MediaVersion", b =>
                {
                    ...
                    b.Property<int?>("FillerMediaItemId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.Filler.FillerMediaItem", b =>
                {
                    b.HasBaseType("ErsatzTV.Core.Domain.MediaItem");
                    ...
                    b.ToTable("FillerMediaItem", (string)null);
                });
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.Filler.Metadata.Product", b =>
                {
                    b.HasOne("ErsatzTV.Core.Domain.Filler.Metadata.Brand", "Brand")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.FillerMetadata", b =>
                {
                    b.HasOne("ErsatzTV.Core.Domain.Filler.FillerMediaItem", "Filler")
                        .WithMany("FillerMetadata")
                        .HasForeignKey("FillerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ErsatzTV.Core.Domain.Filler.Metadata.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.MediaVersion", b =>
                {
                    ...
                    b.HasOne("ErsatzTV.Core.Domain.Filler.FillerMediaItem", null)
                        .WithMany("MediaVersions")
                        .HasForeignKey("FillerMediaItemId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.Filler.FillerMediaItem", b =>
                {
                    ...
                    b.HasOne("ErsatzTV.Core.Domain.MediaItem", null)
                        .WithOne()
                        .HasForeignKey("ErsatzTV.Core.Domain.Filler.FillerMediaItem", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
