...
public class FillerNfoReader : NfoReader<FillerNfo>, IFillerNfoReader
{
    private readonly IClient _client;
    private readonly ILogger<FillerNfoReader> _logger;

    public FillerNfoReader(
        RecyclableMemoryStreamManager recyclableMemoryStreamManager,
        IClient client,
        ILogger<FillerNfoReader> logger)
    ...
    public async Task<Either<BaseError, FillerNfo>> ReadFromFile(string fileName)
    {
    ...
    internal async Task<Either<BaseError, FillerNfo>> Read(Stream input, string fileName)
    {
        FillerNfo? nfo = null;
